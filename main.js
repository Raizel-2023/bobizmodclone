...
console.log(chalk.yellow('🚩ㅤQR صالح للفحص في ستين ثانية فقط و يجب عليك استعمال كود اخر و اعادة الفحص مجددا لذا كن سريعا في الفحص يا عزيزي رايزل يحبكم .'))
}
if (connection == 'open') {
...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ مرحبا بك في مجموعتنا /𝙰* \n*║*\n*╟❧ رايزل يرحب بك يا عزيزي:*\n\n@desc\n\n*║*\n*╟❧ https:// instagram.com/6tl_v!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ الى اللقاء يا عزيزي https:// instagram.com/6tl_v👋🏻* \n*╚══════════════*'
...
let bio = `🤖RAIZELBOT كن في الدنيا كأنك غريب أول كعابر سبيل (استغفر الله تُؤَجر ونُؤْجر عليها ♥`
